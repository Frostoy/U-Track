    ...
    <div class="flex items-center justify-between px-5 py-3 w-full">
      ...
      <div class="flex items-center gap-3">
        <div class="h-10 w-10 rounded-lg bg-white shadow flex items-center justify-center">
          <svg viewBox="0 0 24 24" class="h-6 w-6"><path d="M4 7h16v10H4z" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M7 14c2-3 4-3 6 0 1.5-2.2 3.5-2.2 5 0" stroke="currentColor" stroke-width="1.5" fill="none"/></svg>
        </div>
      ...
      <div class="flex items-center gap-6">
        <nav class="hidden sm:flex items-center gap-8 text-[15px]">
          <a class="font-semibold underline underline-offset-4" href="#">Dashboard</a>
          <a class="text-gray-700 hover:underline" href="#">Inventaris</a>
          <a class="text-gray-700 hover:underline" href="#">Laporan</a>
          <a class="text-gray-700 hover:underline" href="#">Logout</a>
        </nav>
