        ...
        <div class="flex items-center justify-between px-5 py-3 w-full">
            ...
            <div class="flex items-center gap-3">
                <div class="h-10 w-10 rounded-lg bg-white shadow flex items-center justify-center">
                    <svg viewBox="0 0 24 24" class="h-6 w-6">
                        ...
                        <path d="M7 14c2-3 4-3 6 0 1.5-2.2 3.5-2.2 5 0" stroke="currentColor" stroke-width="1.5"
                            fill="none" />
                    </svg>
                </div>
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="flex items-center gap-2 rounded-full bg-teal-200/60 px-3 py-1.5 w-[240px]">
                    <input class="bg-transparent placeholder-gray-600 text-gray-700 text-sm w-full outline-none"
                        placeholder="Cari barang..." />
                    <button
                        class="text-sm font-semibold bg-teal-400 hover:bg-teal-500 text-white rounded-full px-4 py-1">Cari</button>
                </div>
            </div>
        </div>
    </nav>
